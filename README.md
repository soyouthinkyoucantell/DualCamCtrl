...
https://github.com/user-attachments/assets/2cd581a8-7ab3-4e8b-8c6e-f8f99c24f24a
...
#### Put it the checkpoints dir (You could just simply download the HF repo with a dir named 'checkpoints' in it.)
```
