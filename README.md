...
mkdir dependency
cd dependency
# git clone https://github.com/rmbrualla/pycolmap.git # For your convenience^^
cd pycolmap
pip install -e .
pip install numpy==1.26.4 peft accelerate==1.9.0 decord==0.6.0 deepspeed diffusers omegaconf  # override numpy with 1.26.4
```
